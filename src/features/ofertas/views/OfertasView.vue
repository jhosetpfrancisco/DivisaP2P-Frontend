    ...
    <div class="mx-auto max-w-5xl">
      <div class="mb-6 flex items-center justify-between">
        ...
        <div class="flex gap-2">
          <RouterLink to="/ofertas/mias"><BaseButton variant="secondary">Mis ofertas</BaseButton></RouterLink>
          <RouterLink to="/ofertas/nueva"><BaseButton variant="primary">Publicar oferta</BaseButton></RouterLink>
        </div>
      </div>
